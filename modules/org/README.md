...
- In `hub-article`, ordinary Org footnotes export as margin sidenotes; `HUB_NOTE_KIND: footnote` preserves bottom footnotes, while `comment` and `remote-comment` notes are omitted from normal PDF export.
