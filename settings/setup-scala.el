...
")
  ...
  (evil-define-key 'normal scala-mode-map ",gt" 'ensime-goto-test)
  (evil-define-key 'normal scala-mode-map ",gT" 'ensime-goto-impl)
  (evil-define-key 'normal scala-mode-map ",et" 'ensime-sbt-do-test-only-dwim)
  (evil-define-key 'normal scala-mode-map ",eT" 'ensime-sbt-do-test-dwim)
