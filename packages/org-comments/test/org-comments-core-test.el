...
(ert-deftest org-comments-import-report-format-summarizes-provider-counts ()
  ...
  (should (equal (org-comments-import-report-format
		  '(:provider "Google Docs"
			      ...
			      :skipped-resolved 1
			      :preserved-local t))
		 "Google Docs comments: added 2, updated 3, added replies 1, updated replies 1, remote resolved 1, remote missing 1, remote missing replies 1, skipped resolved 1; local content preserved")))
