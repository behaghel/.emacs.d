...
(defun org-comments-sidecar-stamp-properties (properties)
  "Stamp sidecar PROPERTIES alist at point.
Each element is a cons cell of Org property name and value."
  (dolist (property properties)
    (org-comments-sidecar-put-property-when-present (car property) (cdr property))))
