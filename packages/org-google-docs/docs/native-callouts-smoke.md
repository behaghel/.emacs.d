...
- Callouts intentionally do not use the quote indentation style. They use full-width paragraph shading, a small gap below the generated label, and an unmarked empty separator paragraph after each callout because Google Docs paragraph shading can visually merge adjacent shaded paragraphs despite spacing properties.
