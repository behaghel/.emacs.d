...
(defconst org-google-docs--dispatch-actions
  '(("Doctor" . org-google-docs-doctor)
    ("Create Google Doc from buffer" . org-google-docs-create)
    ("Push buffer to Google Docs" . org-google-docs-push)
    ("Pull Google Doc into buffer" . org-google-docs-pull)
    ("Sync current buffer" . org-google-docs-sync-current)
    ("Open linked Google Doc in browser" . org-google-docs-open)
    ("Show Google Docs sync status" . org-google-docs-status)
    ("Import Google Docs comments" . org-google-docs-comments-import)
    ("Authenticate Google account" . org-google-docs-authenticate))
