...
- **Test file:** `test/org-confluence-api-test.el`
- **Tests written first:** raw storage view command construction, basic storage XHTML to Org conversion, nested lists, tables, status chips, emoji fallbacks, panel-like macro callouts, and `hub/confluence-pull` opening an imported Org buffer.
