	...
	(progn
	  ...
	  (with-current-buffer specimen-buffer
	    (hub/test-with-export-compiler-readiness t
							...
							(should (string-match-p (regexp-quote "\\definecolor{HubInlineCodeBrownLifted}{HTML}{76512B}") class-contents))
							(should (string-match-p (regexp-quote "\\definecolor{HubInlineCodeOrange}{HTML}{FF9A52}") class-contents))
							(should (string-match-p (regexp-quote "\\definecolor{HubInlineCodeOrangeSoft}{HTML}{FFE0CC}") class-contents))
							...
							(should (string-match-p (regexp-quote "\\colorlet{HubEmphasisColor}{HubDekWarm}") class-contents))
...
\\colorlet{HubCalloutTitleColor}{HubCalloutEdgeColor}") class-contents))
							...
							(should (string-match-p (regexp-quote "\\tcbuselibrary{raster,minted}") class-contents))
							(should (string-match-p (regexp-quote "\\definecolor{HubPatternMintVivid}{HTML}{95FAEE}") class-contents))
							...
							(should (string-match-p (regexp-quote "\\definecolor{HubTeal}{HTML}{14E5C5}") class-contents))
							(should (string-match-p (regexp-quote "\\definecolor{HubLightTeal}{HTML}{A0FFF0}") class-contents))
							(should (string-match-p (regexp-quote "\\colorlet{HubLinkColor}{HubEmphasisColor}") class-contents))
    ...
    \\colorlet{HubCalloutTitleColor}{HubCalloutEdgeColor}%") class-contents))
							...
							(should (string-match-p (regexp-quote "\\definecolor{HubLine}{HTML}{2F5556}") class-contents))
							(should (string-match-p (regexp-quote "\\definecolor{HubTableRule}{HTML}{2F5556}") class-contents))
							(should (string-match-p (regexp-quote "\\newcommand{\\HubListBullet}{{\\textcolor{HubListMarkerColor}{\\raisebox{-0.9mm}{\\scalebox{1.5}{\\textbullet}}}}}") class-contents))
